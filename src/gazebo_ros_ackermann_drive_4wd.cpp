...
#include "gazebo_ros_ackermann_drive_4wd/gazebo_ros_ackermann_drive_4wd.hpp"
...
{
class GazeboRosAckermannDrive4WDPrivate
{
public:
...
GazeboRosAckermannDrive4WD::GazeboRosAckermannDrive4WD()
: impl_(std::make_unique<GazeboRosAckermannDrive4WDPrivate>())
{
}
...
void GazeboRosAckermannDrive4WD::Load(gazebo::physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  impl_->model_ = _model;
...
//  impl_->ros_node_ = gazebo_ros::Node::Get(_sdf, _model);
  ...
  if (!impl_->joints_[GazeboRosAckermannDrive4WDPrivate::FRONT_RIGHT]) {
    RCLCPP_ERROR(
      impl_->ros_node_->get_logger(),
  ...
  impl_->joints_[GazeboRosAckermannDrive4WDPrivate::FRONT_LEFT] = _model->GetJoint(front_left_joint);
  if (!impl_->joints_[GazeboRosAckermannDrive4WDPrivate::FRONT_LEFT]) {
    RCLCPP_ERROR(
      impl_->ros_node_->get_logger(),
  ...
  impl_->joints_[GazeboRosAckermannDrive4WDPrivate::REAR_RIGHT] = _model->GetJoint(rear_right_joint);
  if (!impl_->joints_[GazeboRosAckermannDrive4WDPrivate::REAR_RIGHT]) {
    RCLCPP_ERROR(
      impl_->ros_node_->get_logger(),
  ...
  impl_->joints_[GazeboRosAckermannDrive4WDPrivate::REAR_LEFT] = _model->GetJoint(rear_left_joint);
  if (!impl_->joints_[GazeboRosAckermannDrive4WDPrivate::REAR_LEFT]) {
    RCLCPP_ERROR(
      impl_->ros_node_->get_logger(),
  ...
  impl_->joints_[GazeboRosAckermannDrive4WDPrivate::STEER_RIGHT] =
    _model->GetJoint(right_steering_joint);
  if (!impl_->joints_[GazeboRosAckermannDrive4WDPrivate::STEER_RIGHT]) {
    RCLCPP_ERROR(
      impl_->ros_node_->get_logger(),
  ...
  impl_->joints_[GazeboRosAckermannDrive4WDPrivate::STEER_LEFT] =
    _model->GetJoint(left_steering_joint);
  if (!impl_->joints_[GazeboRosAckermannDrive4WDPrivate::STEER_LEFT]) {
    RCLCPP_ERROR(
      impl_->ros_node_->get_logger(),
  ...
  impl_->wheel_radius_ = impl_->CollisionRadius(
    impl_->joints_[GazeboRosAckermannDrive4WDPrivate::REAR_RIGHT]->GetChild()->GetCollision(id));
  ...
  auto front_right_center_pos = impl_->joints_[GazeboRosAckermannDrive4WDPrivate::FRONT_RIGHT]->
    GetChild()->GetCollision(id)->WorldPose().Pos();
  auto front_left_center_pos = impl_->joints_[GazeboRosAckermannDrive4WDPrivate::FRONT_LEFT]->
    GetChild()->GetCollision(id)->WorldPose().Pos();
  auto rear_right_center_pos = impl_->joints_[GazeboRosAckermannDrive4WDPrivate::REAR_RIGHT]->
    GetChild()->GetCollision(id)->WorldPose().Pos();
  auto rear_left_center_pos = impl_->joints_[GazeboRosAckermannDrive4WDPrivate::REAR_LEFT]->
    GetChild()->GetCollision(id)->WorldPose().Pos();
  ...
  impl_->cmd_vel_sub_ = impl_->ros_node_->create_subscription<geometry_msgs::msg::Twist>(
    ...
    std::bind(&GazeboRosAckermannDrive4WDPrivate::OnCmdVel, impl_.get(), std::placeholders::_1));
  ...
  impl_->update_connection_ = gazebo::event::Events::ConnectWorldUpdateBegin(
    std::bind(&GazeboRosAckermannDrive4WDPrivate::OnUpdate, impl_.get(), std::placeholders::_1));
}

void GazeboRosAckermannDrive4WD::Reset()
{
...
void GazeboRosAckermannDrive4WDPrivate::OnUpdate(const gazebo::common::UpdateInfo & _info)
{
  #ifdef IGN_PROFILER_ENABLE
  IGN_PROFILE("GazeboRosAckermannDrive4WDPrivate::OnUpdate");
  #endif
...
void GazeboRosAckermannDrive4WDPrivate::OnCmdVel(const geometry_msgs::msg::Twist::SharedPtr _msg)
{
...
double GazeboRosAckermannDrive4WDPrivate::CollisionRadius(const gazebo::physics::CollisionPtr & _coll)
{
...
void GazeboRosAckermannDrive4WDPrivate::UpdateOdometryWorld()
{
...
void GazeboRosAckermannDrive4WDPrivate::PublishOdometryTf(const gazebo::common::Time & _current_time)
{
...
void GazeboRosAckermannDrive4WDPrivate::PublishWheelsTf(const gazebo::common::Time & _current_time)
{
...
void GazeboRosAckermannDrive4WDPrivate::PublishOdometryMsg(const gazebo::common::Time & _current_time)
{
  // Set covariance
...
GZ_REGISTER_MODEL_PLUGIN(GazeboRosAckermannDrive4WD)
}  // namespace gazebo_plugins
